...
export default function Home(){
  return <main>
    ...
    <section className="cover paper" id="top"><div className="grain"/><div className="coverCore"><p className="tinyRule">刘家华 / LIU JIAHUA</p><h1>port<span>folio</span></h1><h2>个人作品集</h2><p>数字营销 · 内容增长</p><a href="#about" className="primaryBtn">点我进入 <b>↘</b></a></div><span className="doodle d1">♥</span><span className="doodle d2">✦</span><span className="cornerNote">深圳 · 广州 / 2026</span></section>

    <section className="about paper section" id="about"><div className="grain"/><div className="aboutCopy"><span className="eyebrow">刘家华 / JIAHUA LIU</span><h2>刘家华</h2><p>专注小红书、Instagram与TikTok等平台，结合关键词调研与A/B测试，用AI工具辅助高效产出英文内容，让品牌与创作者的合作更真实、更有效。</p><div className="tagRow"><span>达人运营</span><span>用户分层</span><span>内容策划</span><span>生命周期运营</span><span>数据复盘</span></div><div className="aboutActions"><a href="#work" className="primaryBtn">查看品牌 →</a><a href="mailto:ryanliu200212@gmail.com" className="outlineBtn">联系我</a></div></div><div className="photoDesk"><div className="tape"/><figure className="polaroid mainPhoto"><img src="/profile-duck.jpg" alt="戴着眼镜在电脑前工作的小黄鸭头像"/><figcaption>jiahua :)</figcaption></figure><div className="noteCard"><b>what I do</b><span>内容策划</span><span>达人协作</span><span>用户运营</span></div></div></section>
